...
- [architecture](docs/ARCHITECTURE.md), [implemented core contracts](docs/CORE-CONTRACTS.md), [native static engine](docs/NATIVE-STATIC-ENGINE.md), [static HTML semantics](docs/SEMANTIC-HTML.md), [local state](docs/STATE-STORE.md), [complete observations](docs/OBSERVATIONS.md), [relevance and budgeting](docs/RELEVANCE.md), [authorized actions](docs/ACTIONS.md), [action batches](docs/BATCHES.md), [engine contract](docs/ENGINE-CONTRACT.md), and [agent protocol](docs/PROTOCOL.md);
