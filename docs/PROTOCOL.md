...
No public agent protocol, MCP tools, or wire implementation exists yet. The concepts below establish ownership and invariants without freezing exact schemas prematurely.
